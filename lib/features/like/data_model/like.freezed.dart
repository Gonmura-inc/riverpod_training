...
class _$_Like implements _Like {
  ...
  @override
  String toString() {
    return 'Like(likeId: $likeId, taskId: $taskId, userId: $userId, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, likeId, taskId, userId, createdAt);
...
abstract class _Like implements Like {
  factory _Like(
      ...
      @TimestampConverter() required final Timestamp createdAt}) = _$_Like;
